...
INSERT INTO `config` VALUES (1,'Godown','false'),(2,'GSTTypeId','0'),(3,'StockTypeId','0'),(4,'ExpireDate','false'),(5,'BatchNo','false');
...
INSERT INTO `controlmaster` VALUES (1,'GstAmount','0',4,NULL,NULL),(2,'SgstAmount ','0',4,NULL,NULL),(3,'GrantTotal','0',4,NULL,NULL);
...
INSERT INTO `controltype` VALUES (0,'Hideen'),(1,'Text'),(2,'Password'),(3,'ComboBox'),(4,'Radio'),(5,'CheckBox'),(6,'Image'),(7,'UPload'),(8,'Date');
...
INSERT INTO `formmaster` VALUES (1,1,'ItemMaster.js'),(2,2,'AccountMaster.js'),(3,3,'UnitMaster.js'),(4,4,'inventory.js'),(5,5,'cash.js'),(6,7,'bank.js'),(7,0,'jv.js');
...
CREATE TABLE `itemmaster` (
  ...
  `QuantityTypeId` int(11) DEFAULT NULL COMMENT 'Quantity Type',
...
INSERT INTO `itemmaster` VALUES (22,'aaa',1,2,0,5),(23,'dddd',4,4,3,10),(24,'kkk',10,20,1,12),(26,'popto',10,20,2,NULL),(27,'bbb',100,200,1,NULL),(28,'ccc',1000,2000,2,NULL),(29,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `menumaster` VALUES (1,1,'Master',NULL,'deluxstate',NULL,1,NULL,NULL),(2,1,'Item',NULL,'deluxstate',1,1,'select * from vwitemmaster',8),(3,1,'Account',NULL,'deluxstate',2,1,'select *  from vwaccountmaster',7),(4,1,'Unit',NULL,'deluxstate',3,1,'select *  from UnitMaster',NULL),(5,1,'Group Master',NULL,'deluxstate',NULL,0,NULL,NULL),(6,1,'State Master',NULL,'deluxstate',NULL,0,NULL,NULL),(7,1,'AccountDetail',NULL,'deluxstate',NULL,NULL,'select *, if((@balance:=@balance%2Bbal)>0,concat(round(@balance,2),\' Cr\'),concat( round(@balance*-1,2),\' Dr\')) as Balance from vwaccountdetails join (Select @balance:=0) x where AccountMasterId={{UniqueId}}',NULL),(8,1,'ItemDetail',NULL,'deluxstate',NULL,NULL,'select * ,@balance:=@balance%2BStock  as StockQty from vwitemdetails join (Select @balance:=0) x  where ItemMasterId={{UniqueId}}',NULL),(100,100,'Transction',NULL,'deluxstate',NULL,1,'select *  from vwtranscation',NULL),(101,100,'Purchase Vouchase','lime','deluxform',5,1,NULL,10),(102,100,'Sales Vouchase','Brown','deluxform',5,1,NULL,11),(103,100,'Purachase Return','','deluxform',0,0,NULL,NULL),(104,100,'Sales Return','','deluxform',0,0,NULL,NULL),(105,100,'Cash Receipt','Green','deluxform',4,1,NULL,12),(106,100,'Cash Payment','Red','deluxform',4,1,NULL,13),(107,100,'Bank Receipt','pink','deluxform',6,1,NULL,14),(108,100,'Bank Payment','Orange','deluxform',6,1,NULL,15),(109,100,'Journal Vourcher','Yellow','deluxform',7,1,NULL,16),(1000,1000,'Report',NULL,'deluxstate',NULL,1,NULL,NULL),(1001,1000,'DayBook',NULL,NULL,NULL,1,'call  preDaybook',NULL),(1002,1000,'TrialBalance',NULL,NULL,NULL,1,'call  preTrialBalance',NULL),(1003,1000,'Trading Account',NULL,'deluxstate',NULL,1,'call preTradingAccount',NULL),(1004,1000,'Proft & Loss Account',NULL,'deluxstate',NULL,1,'call preProfitAndLoss',NULL),(1005,1000,'Balance Sheet',NULL,'deluxstate',NULL,1,'call  preBalanceSheet',NULL),(1006,1000,'Cash Flow',NULL,'deluxstate',NULL,1,'call preCashFlow',NULL),(1007,1000,'Fund Flow',NULL,'deluxstate',NULL,1,'call preFundFlow',NULL),(1008,1000,'GST Report',NULL,NULL,NULL,1,'call PreGST',NULL),(2000,2000,'Utility',NULL,'deluxstate',NULL,1,'',NULL),(2001,2000,'Setting',NULL,'deluxstate',NULL,1,NULL,NULL),(2002,2000,'Change Password',NULL,'deluxstate',NULL,1,NULL,NULL),(2003,2000,'Buckup & Restore',NULL,'deluxstate',NULL,1,NULL,NULL);
...
INSERT INTO `tablemaster` VALUES (1,'ItemMaster','ItemMasterId',1),(2,'AccountMaster','AccountMasterId',2),(3,'UnitMaster','UnitMasterId',3),(4,'Tran','TranId',4),(5,'Tran','TranId',5),(6,'Trandetails','TranId',5),(7,'Tran','TranId',7),(8,'TranFin','TranId',7);
...
INSERT INTO `tran` VALUES (167,NULL,NULL,11,NULL,NULL,NULL,NULL,NULL,NULL),(171,'4','2019-03-07',NULL,16,'0','44',NULL,NULL,NULL),(172,'1','2019-03-08',7,2,'40','333',NULL,NULL,NULL),(173,'3','2019-03-15',11,12,'44','44',NULL,NULL,NULL),(174,'2','2019-03-15',6,10,'42712.5',NULL,NULL,NULL,NULL),(175,'333','2019-03-17',6,2,'40','test',NULL,NULL,NULL),(176,'4','2019-03-17',6,10,'30',NULL,NULL,NULL,NULL),(177,'2','2019-03-21',6,10,'50','3',NULL,NULL,NULL),(178,'4','2019-03-21',6,10,'100',NULL,NULL,NULL,NULL),(179,'5','2019-03-21',6,10,'150','333',NULL,NULL,NULL),(180,'3','2019-03-21',6,10,'200',NULL,NULL,NULL,NULL),(181,'20','2019-03-21',6,10,'200','3',NULL,NULL,NULL),(182,'7','2019-03-21',6,10,'250','7',NULL,NULL,NULL),(183,'1','2019-03-22',6,12,'222','222',NULL,NULL,NULL),(184,'2','2019-03-23',6,12,'2','2',2,2,2),(185,'2','2019-03-23',10,13,'33','test',NULL,NULL,NULL);
...
INSERT INTO `trandetails` VALUES (160,167,NULL,22,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,1,12),(173,172,1,26,12,12,NULL,1,2,2,20,40,NULL,NULL,NULL,NULL,'sddd',0,NULL,NULL,NULL,NULL,NULL),(174,174,1,26,20,10,NULL,142.375,30,4271.25,10,42712.5,2,NULL,'2019-03-26','33','333',0,NULL,NULL,NULL,2,1),(175,175,1,22,NULL,NULL,NULL,NULL,NULL,20,2,40,NULL,NULL,NULL,NULL,'33',0,NULL,NULL,NULL,NULL,NULL),(176,176,1,26,12,12,NULL,1,3,3,10,30,3,NULL,'2019-03-25','44','333',0,NULL,NULL,NULL,2,2),(177,177,1,22,NULL,NULL,NULL,NULL,NULL,10,5,50,5,NULL,'2019-03-26','5','55',0,NULL,NULL,NULL,2,3),(178,178,1,22,NULL,NULL,NULL,NULL,NULL,10,10,100,10,NULL,'2019-03-21',NULL,NULL,0,NULL,NULL,NULL,1,1),(179,179,1,22,NULL,NULL,NULL,NULL,NULL,15,10,150,5,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,1,2),(180,180,1,22,NULL,NULL,NULL,NULL,NULL,20,10,200,5,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,2,2),(181,181,1,22,NULL,NULL,NULL,NULL,NULL,20,10,200,5,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,1),(182,182,1,22,NULL,NULL,NULL,NULL,NULL,25,10,250,5,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `unitmaster` VALUES (1,'Kg','Kilo Grame'),(2,'Ltr','Liter'),(3,'Box','Box'),(8,'dz','dozen'),(12,'ppp','ppp5');
...
-- Dump completed on 2019-03-23 10:28:28
