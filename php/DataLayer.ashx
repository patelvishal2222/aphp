 ...
 #region Nested type: DynamicJsonObject
  ...
  //public static bool TryRemoveMember(object dynamicObject, string memberName, out object removedMember);
    ...
    public class DBLayer
    {
        ...
        public DynamicJsonObject GetObject(string PrimaryKey, string PrimaryValue, DynamicJsonObject objDynamicJsonObject, ArrayList MasterTable,bool dictionaryDetail=false )
        {
            ...
            foreach (System.Collections.Generic.KeyValuePair<string, object> obj in objDynamicJsonObject)
            {
                ...
                if (obj.Value.GetType().IsArray == true)
                {
                    ...
                    for (int i = 0; i < objdata.Length; i++)
                    {
                        ...
                        DynamicJsonObject resultDynamicJsonObject2 = GetObject(PrimaryKey, PrimaryValue, obj1, MasterTable,true);
                ...
                else if (obj.Value.GetType().ToString() == "System.String")
                {
                    ...
                    {
                      //  System.Collections.ArrayList objes = new System.Collections.ArrayList();
                        //if (dt.Rows.Count == 1)
                        //    objes.Add(resultDynamicJsonObject);
        ...
        public int saveRecord(MasterDB masterDB, string TableName, DynamicJsonObject TableData, DynamicJsonObject MasterKeyValue, HttpResponse Response)
        {
            int Id = 0;
            try
            {
        ...
        public void SaveDetail(MasterDB objMsSqlDB, DynamicJsonObject DetailTables, DynamicJsonObject MasterKeyValue, HttpResponse Response)
        {
              ...
              $f=$insertKey.",";
               $v=$insertValue.",";
                ...
                foreach (dynamic objdata in TableData)
                {
                    ...
                    {
                        string VirtualTable = key.ToString().Substring(7);
                          f=f+VirtualTable+"Id,";
